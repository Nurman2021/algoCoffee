<script>
  ...
  import { Chrome, Instagram } from 'lucide-svelte';

  let expand = false;
</script>

<svelte:head>
    <title>Algo Coffee Web</title>
   ...
   <header class="fixed w-full z-10">
        <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a href="/" class="flex items-center">
                    <img src="/images/favicon.png" class="h-6 mr-3 sm:h-9" alt="Landwind Logo" />
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Algo Coffee</span>
                </a>
                <div class="flex items-center lg:order-2">
                    <Theme/>
                    <button type="button" class="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" on:click={() => expand = !expand}>
                    ...
                    <div class={`lg:flex items-center justify-between w-full lg:space-x-4 lg:w-auto lg:order-1 ${expand ? 'block' : 'hidden'} lg:block`}>
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <a href="/" class="block py-2 pl-3 pr-4 text-white bg-purple-700 rounded lg:bg-transparent lg:text-sky-500 lg:p-0 dark:text-white" aria-current="page">Home</a>
                        </li>
                        <li>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl h-screen px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-8 lg:grid-cols-12 grid-rows-12 lg:pt-28">
            <div class="lg:mt-0 lg:col-span-5 lg:flex lg:order-last lg:row-span-12 row-span-5">
                  <App />
            </div>
            <div class="mr-auto place-self-center lg:col-span-7 lg:row-span-12 row-span-7">
                ...
                <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                    ...
                    <a href="https://www.instagram.com/algokopi" class="inline-flex gap-1 items-center justify-center w-full px-5 py-3 mb-2 mr-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:w-auto focus:outline-none hover:bg-gray-100 hover:text-rose-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                        <Instagram /> AlgoKopi
                    </a>
                </div>
            </div>                
        ...
        <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            ...
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Kopi Premium</h2>
                    <p class="mb-8 font-light text-sm lg:text-xl">Deliver great service experiences fast - without the complexity of traditional ITSM solutions. Accelerate critical development work, eliminate toil, and deploy changes with ease.</p>
                    <!-- List -->
                    <ul role="list" class="pt-8 space-y-5 border-t border-gray-200 my-7 dark:border-gray-700">
                        <li class="flex space-x-3">
                            <!-- Icon -->
                            <svg class="flex-shrink-0 w-5 h-5 text-sky-500 dark:text-sky-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                ...
                <img class="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" src="/images/kopi-1.jpg" alt="dashboard feature image">
            </div>
            <!-- Row -->
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <img class="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" src="/images/kopi-2.jpg" alt="feature image 2">
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
            ...
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Ramah untuk Anak IT</h2>
                    <p class="mb-8 font-light lg:text-xl">Deliver great service experiences fast - without the complexity of traditional ITSM solutions. Accelerate critical development work, eliminate toil, and deploy changes with ease.</p>
                    <!-- List -->
                    <ul role="list" class="pt-8 space-y-5 border-t border-gray-200 my-7 dark:border-gray-700">
                        <li class="flex space-x-3">
                ...
                <img class="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" src="/images/kopi-3.jpg" alt="dashboard feature image">
            </div>
        </div>
      </section>
    <!-- End block -->
    ...
    <section class="bg-white dark:bg-gray-900" id="galery">
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
            <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
                ...
                <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Lihat suasana hangat kami yang menginspirasi banyak cerita indah</p>
            </div>
            <Swiper/>
        </div>
      </section>
