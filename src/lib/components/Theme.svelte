...
<button
	class="{dark
		...
		: 'focus:ring-sky-400 ring-offset-white'} border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 m-4"
	class:hidden
	on:click={toggle}
>
	<!-- moon icon -->
	...
	<!-- sun icon -->
	<svg class="h-5 w-5 text-sky-500" class:hidden={dark} viewBox="0 0 20 20" fill="currentColor">
		<path
			fill-rule="evenodd"
